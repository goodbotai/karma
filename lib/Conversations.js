...
function Conversations() {
  ...
  function repeatAnyoneObject(conversation) {
    ...
    try {
       withWhom = conversation.responses.with_whom.text;
    } catch (TypeError) {
      withWhom = null;
    }

    try {
       withWhomRelationship = conversation.responses.with_whom_welationship.text;
    } catch (TypeError) {
    ...
    return {
      with_whom: withWhom,
      with_with_relationship: withWhomRelationship,
    };
  }
