...
function Conversations() {
  ...
  function conversation_switch(response, conversation, callback) {
  ...
  function next_conversation (response, conversation) {
    conversation_switch(response,
                        conversation,
                        conversation.next()
                       );
  }
  ...
  function repeatObject(conversation, payload) {
    ...
    let spoke_to, relationship, change, what, scale;
    ...
    try {
      scale = conversation.responses['social_concern_change_scale']['text'];
    }  catch (TypeError) {
      what = null;
    }
    ...
    return {
      ...
      social_concern_change_scale: scale,
