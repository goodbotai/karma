...
function Conversations() {
  ...
  function karmaConversation(err, convo, locale, firstName, lastName) {
    ...
    convo.addQuestion(
          generateYesNoButtonTemplate('Are you near someone you know ' +
                                  'right now?',
                                  'yes_with_someone',
                                  'no_with_someone'),
          [{
        ...
        convo.addQuestion(
          generateYesNoButtonTemplate('Have you spoken to someone ' +
                                  'about' +
        ...
        convo.addQuestion(
          generateYesNoButtonTemplate('Did talking about ' +
                                  '{{responses.social_concern}} ' +
        ...
        convo.addQuestion(
          generateYesNoButtonTemplate('Have you talked about ' +
                                  '{{responses.social_concern}} ' +
                                  'with anyone else?',
                                  'yes_anyone_else',
                                  'no_anyone_else'),
