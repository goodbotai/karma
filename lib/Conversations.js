...
function Conversations() {
  ...
  function karmaConversation(err, convo) {
    ...
    const preExecService = Services(convo);
    const messengerId = preExecService.messengerId;

    preExecService.getFacebookProfile(facebookApiVersion, messengerId, facebookPageAccessToken)
