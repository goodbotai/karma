  ...
  */
  ...
  convo.addQuestion(
    generateQuickReply(t(`${lang}:withWhomRelationship`),
                       relationships),
    validateAnswer(txt => relationships.includes(txt), goto('with anyone else'), lang),
  ...
  emotions.map((emo) => convo.addQuestion(
    ...
    emo === 'active' ?
    validateAnswer((txt) => /^([1-5])$/.test(txt), goto('social concern'), lang) :
  ...
  emotions.map((emo) => convo.addQuestion(
    generateQuickReply(t(`${lang}:emotions.${emo}`), nums5),
    emo === 'active' ?
    validateAnswer((txt) => /^([1-5])$/.test(txt), goto('social concern spoken'), lang)
    : validateAnswer((txt) => /^([1-5])$/.test(txt), nextConversation, lang),
  ...
  convo.addQuestion(
    generateQuickReply(
      ...
      validateAnswer(txt => relationships.includes(txt),goto('social concern confidant'), lang),
  ...
  convo.addQuestion(
    ...
    validateAnswer((txt) => /^([1-9]|10)$/.test(txt), goto('what changed'), lang),
