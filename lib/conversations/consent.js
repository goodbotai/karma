...
/**
 * Create a user in RapidPro and submit the details to ONA in a transaction
 * @param {object} message  Conversation message object from botkit
 * @param {object} profile facebook profile of the user
 * @param {object} convo the conversation object
 * @param {string} referringSurveyUUID UUID of the survey that lead the user to the bot
 * @param {object} submissionUUID the UUID of the create user submission in ONA.
 * @param {object} retries - number of times to retry the transaction
 */
async function transactConsentApproval(
  message,
  profile,
  convo,
  referringSurveyUUID,
