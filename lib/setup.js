...
const secondSurvey = require('./conversations/two.js');
// const botThree = require('./conversations/three.js');


// TODO: why do I have two versions of this fn?
/**
...
function setup(bot) {
   ...
   * @return {undefined} - the result of starting a conversation
   */
  ...
  facebook.start(bot, (err, webserver) => {
    ...
    webserver.post('/trigger/two', (req, res) => {
      sendGreeting(req.body, 'two')
        .then(() => {
          res.json({text: 'Successfully triggered messnger message'});
          res.statusCode = 200;
          res.send();
        })
        .catch((err) => {
